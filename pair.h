...
struct pair 
{
    ...
    pair(
        ...
        : pair(
            first, 
            second, 
            typename std::_Build_index_tuple<sizeof...(Args1)>::__type(),
            typename std::_Build_index_tuple<sizeof...(Args2)>::__type()
          )
    {
    }
...
private:
    ...
    pair(std::tuple<Args1...>& tuple1, std::tuple<Args2...>& tuple2,
	 std::_Index_tuple<Indexes1...>, 
         std::_Index_tuple<Indexes2...>
    )
